...
import com.example.EventsProject.Controllers.AdsController;
...
public class AdsService {
    ...
    public void applyAd(Ad ad, User user) throws IllegalStateException {
        ...
        if (!applicants.contains(user)) {
            ...
            throw new IllegalStateException(String.format("User %s has already applied to ad %d", user.getName(), ad.getId()));
        }
    }
